...
export default function CardFooter({className = "", roundedTop = false}) {
    return (
        <div className={'bg-white flex flex-col divide-y divide-stone-100 rounded-b-md ' + className}>
            <button className={`w-full min-h-[44px] flex gap-2 px-3 items-center justify-center relative text-sm hover:bg-stone-100 ${roundedTop ? "rounded-t-md" : ""}`}>
            ...
            <button className='w-full min-h-[44px] flex gap-2 px-3 items-center justify-center relative text-sm hover:bg-stone-100'>
            ...
            <button className='w-full min-h-[44px] flex gap-2 px-3 items-center justify-center relative text-sm hover:bg-stone-100 rounded-b-md'>
